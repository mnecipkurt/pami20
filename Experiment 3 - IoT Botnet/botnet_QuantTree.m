...
N_vec = zeros(K,1); N_vec(1:9) = 819; N_vec(10:end) = 820;
sum(N_vec);
...
no_trials = 500; % number of trials
h = (1:1:178)';
sum_fap = zeros(length(h),1);
for mm = 1:no_trials
    mm
    % initial window (free of anomaly, randomly chosen)
